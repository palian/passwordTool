...
{	
	...
	else
	{
		...
		[theLock setValue:locationField.text forKey:@"lockLocation"];
		[theLock setValue:fillingField.text forKey:@"lockSlider1"];
		[theLock setValue:breadField.text forKey:@"lockSlider2"];
